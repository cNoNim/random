...
namespace Testing
{
	public class RandomnessTest
	{
		...
		private string GetResult(EntCalc.EntCalcResult result, float duration)
		{
			...
			var combined = Math.Min(Math.Min(Math.Min(meanValueQuality, serialCorrelationQuality), piQuality),
				diagonalsDeviationQuality);
